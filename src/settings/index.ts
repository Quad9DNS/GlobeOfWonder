...
export class Settings extends EventTarget {
  ...
  @SettingsField()
  accessor enableGraphCommands: boolean = true;
...
export function setupSettingsDialog(
  ...
  for (const [selector, type, property] of [
    ...
    ["#enablegraphcommands", "boolean", "enableGraphCommands"],
  ...
  const smoothEventCountersUpdatesField =
    fields.dialogContainer.querySelector<HTMLInputElement>(
  ...
  dialogContainer.innerHTML = `
    <dialog id="settingsDialog" class="dialog-container">
      <div id="settingsDialogArea" class="two-col-grid">
        ...
        <label for="enablegraphcommands">Enable graph commands:</label>
        <input type="checkbox" id="enablegraphcommands" name="enablegraphcommands" />
