...
| sound_set                          | - (required - play_soundset_command only)         | List of soundset objects to be played (either sound_link or sound_pause) - sounds are played sequentially. Any failure stops the whole sequence      |
