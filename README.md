...
| Key                                | Default value                                     | Description                                                                                                                                          |
|------------------------------------|---------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------|
| type                               | - (required)                                      | Type of the command (clear_map_command, view_command, settings_command, show_textbox_command)                                                                           |
...
| border_color                       | transparent                                       | Color of the textbox borders                                                                                                                         |
| border_thickness                   | medium                                            | Thickness of the textbox borders in pixels                                                                                                           |
| border_opacity                     | 100                                               | Opacity of the textbox borders (0-100)                                                                                                               |
